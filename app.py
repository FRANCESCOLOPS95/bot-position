...
# 🔐 Legge da environment (Render) oppure fallback locale
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8677643454:AAFl0hpdVeTAVKcJrOZTeu64VKSQTk6xoQY")
CHAT_ID = os.environ.get("CHAT_ID", "7714751615")
